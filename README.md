...
> ⏳ **В планах**: развёртывание в Kubernetes (Yandex Cloud), управление ACL и группами потребителей, поиск сообщений, мониторинг.

---

## ✨ Возможности

- 🖥️ **Современный интерфейс** – боковое меню, тёмная тема (в стиле Kubernetes Dashboard), выбор активного кластера.
